 ...
 */
public class VelocityTableColor extends javax.swing.JFrame implements VelocityObserver
{

    /**
     * Creates new form VelocityTableColor
     */
    public VelocityTableColor()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(lbBackground, javax.swing.GroupLayout.PREFERRED_SIZE, 400, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(VelocityTableColor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                new VelocityTableColor().setVisible(true);
            }
        });
    }
